...
public class MaxCommand implements ProductCommand {
    ProductHtmlFormatting formatting;
    ProductDAO productDAO;
    public MaxCommand(ProductHtmlFormatting formatting, ProductDAO dao){
        this.productDAO = dao;
        this.formatting = formatting;
    }
    @Override
    public String toHtml() throws SQLException, IOException {
        return formatting.productToHtml(productDAO.getMaxProduct().get(),"Product with max price: ");
    }
}
